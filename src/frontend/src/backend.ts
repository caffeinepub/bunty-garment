...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: number): Promise<T__1> {
    ...
    async addProductCategory(arg0: string, arg1: string): Promise<T> {
        if (this.processError) {
            try {
                const result = await this.actor.addProductCategory(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllProductCategories(): Promise<Array<T>> {
        if (this.processError) {
            try {
    ...
    async getAllProducts(): Promise<Array<T__1>> {
        if (this.processError) {
            try {
    ...
    async getProduct(arg0: bigint): Promise<T__1> {
        if (this.processError) {
            try {
    ...
    async getProductCategory(arg0: bigint): Promise<T> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
